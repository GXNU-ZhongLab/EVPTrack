...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='evptrack', help='training script name')
    parser.add_argument('--config', type=str, default='EVPTrack-full-384', help='yaml configure file name')
    ...
    parser.add_argument('--nproc_per_node', type=int, default=4, help="number of GPUs per node")  # specify when mode is multiple
