...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='evptrack', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='EVPTrack-full-224', help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='EVPTrack-full-224', help='Name of save file.')
