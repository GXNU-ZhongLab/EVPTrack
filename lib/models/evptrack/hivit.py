...
from lib.models.evptrack.base_backbone import BaseBackbone
...
class HiViT(BaseBackbone):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000,
        ...
        self.STE = BlockWithRPE(Hp, embed_dim, nhead, ratio, qkv_bias, qk_scale, 
                        drop=drop_rate, attn_drop=attn_drop_rate, 
                        rpe=rpe, norm_layer=norm_layer,)
        self.MSPG = nn.Linear(embed_dim, embed_dim,bias=False)
        self.STPG = nn.Linear(embed_dim, embed_dim,bias=False)
