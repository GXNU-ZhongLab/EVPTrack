...
trackers = []
dataset_name = 'lasot'#lasot_extension_subset'#uav'
"""stark"""
...
"""evptrack"""
trackers.extend(trackerlist(name='evptrack', parameter_name='EVPTrack-full-224', dataset_name=dataset_name,
                            save_name='EVPTrack-full-224', run_ids=None, display_name='EVPTrack-full-224'))
